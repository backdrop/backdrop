...
if (version_compare(PHP_VERSION, '7.2.0') < 0) {
  print 'Your PHP installation is too old. Backdrop CMS requires at least PHP 7.2.0. See the <a href="https://backdropcms.org/guide/requirements">System Requirements</a> page for more information.';
  exit;
}
