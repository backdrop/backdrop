...
$.extend(CollapsibleFieldset.prototype, {
  ...
  setupLegend: function () {
    ...
    $('<span class="fieldset-legend-prefix element-invisible"></span>')
      .append(this.$node.hasClass('collapsed') ? Backdrop.t('Show') : Backdrop.t('Hide'))
      .prependTo($legend)
      .after(' ');
  ...
  onSummaryUpdated: function () {
    var text = $.trim(this.$node.backdropGetSummary());
...
Backdrop.CollapsibleFieldset = CollapsibleFieldset;
