...
Backdrop.behaviors.blockSettingsSummary = {
  attach: function (context) {
    ...
    $('#edit-path').backdropSetSummary(function (context) {
    ...
    $('#edit-node-type').backdropSetSummary(function (context) {
      var vals = [];
    ...
    $('#edit-role').backdropSetSummary(function (context) {
      var vals = [];
      $('input[type="checkbox"]:checked', context).each(function () {
        vals.push($.trim($(this).next('label').text()));
      });
    ...
    $('#edit-user').backdropSetSummary(function (context) {
  ...
  attach: function (context, settings) {
    ...
    tableDrag.onDrop = function () {
      ...
      if ($('option[value=' + regionName + ']', regionField).length == 0) {
        ...
        window.alert(Backdrop.t('The block cannot be placed in this region.'));
