 ...
 *   - display modes: An array describing the display modes for the entity type.
 ...
 *     the requested display mode. An additional 'default' display mode is
 ...
 * default display settings. For each available display mode, administrators can
 * configure whether it should use its own set of field display settings, or
 * just replicate the settings of the 'default' display mode, thus reducing the
 * amount of display configurations to keep track of.
 *
...
/**
 * Act on a display mode which is being renamed.
 *
 * @param $entity_type
 *   The type of entity being saved (i.e. node, user, comment).
