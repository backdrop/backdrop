 ...
 *   as "node" or "user".
 * - $ol_start: The starting number for the ordered list, calculated from the
 *   current pager page so numbering is sequential across pages.
 *
 * @since 1.34.3 Added ol_start attribute.
 *
