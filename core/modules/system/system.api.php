 ...
 * display those pages differently (For example, in a different theme).
 *
...
function hook_batch_alter(&$batch) {
  // Add a query string ?foo=bar to the end of a batch URL.
  if (isset($batch['url_options']['query'])) {
    $batch['url_options']['query']['foo'] = 'bar';
  }
  else {
    $batch['url_options']['query'] = array('foo' => 'bar');
  }
}
