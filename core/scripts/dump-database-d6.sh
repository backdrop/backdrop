...
/**
 * Dump a Backdrop 6 database into a Backdrop 7 PHP script to test the upgrade
 * process.
 *
 * Run this script at the root of an existing Backdrop 6 installation.
 *
 * The output of this script is a PHP script that can be ran inside Backdrop 7
 * and recreates the Backdrop 6 database as dumped. Transient data from cache
...
/**
 * @file
 * Filled installation of Backdrop 6.17, for test purposes.
 *
 * This file was generated by the dump-database-d6.sh tool, from an
 * installation of Backdrop 6, filled with data using the generate-d6-content.sh
