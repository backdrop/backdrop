...
/**
 * Dump a Backdrop 7 database into a Backdrop 7 PHP script to test the upgrade
 * process.
 *
 * Run this script at the root of an existing Backdrop 7 installation.
 *
 * The output of this script is a PHP script that can be run inside Backdrop 7
 * and recreates the Backdrop 7 database as dumped. Transient data from cache,
