...
function seven_tablesort_indicator($variables) {
  ...
  if ($style == 'asc') {
    return theme('image', array('path' => $theme_path . '/images/long-arrow-up--white--64.png', 'alt' => t('sort ascending'), 'width' => 16, 'height' => 16, 'title' => t('sort ascending')));
  }
  else {
    return theme('image', array('path' => $theme_path . '/images/long-arrow-down--white--64.png', 'alt' => t('sort descending'), 'width' => 16, 'height' => 16, 'title' => t('sort descending')));
  }
}
